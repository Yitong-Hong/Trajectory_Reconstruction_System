...
def update_tracker(target_detector, image,bboxes):
    ...
    for x1, y1, x2, y2, conf, cls_id in bboxes:
        obj = [
    ...
    # print("tracker.py, bbox_xywh.shape:",len(bbox_xywh))
    # print("tracker.py, bbox_xywh[0]:",bbox_xywh[0])
    xywhs = torch.Tensor(bbox_xywh)
    confss = torch.Tensor(confs)

    # print("tracker.py, xywh[0]:",xywhs[0])

    # print("tracker.py, xywhs:",xywhs)
