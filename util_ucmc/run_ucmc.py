...
def run_ucmc(args, det_path="det_results/mot17/yolox_x_ablation",
    ...
    if dataset == "MOT17":
        ...
        cam_para = os.path.join(cam_path, f"{seq_name}-SDP.txt") # cam_para/MOT17/MOT17-13-SDP.txt
    ...
    detector.load(cam_para, det_file, gmc_file) # cam_para/MOT17/MOT17-13-SDP.txt
