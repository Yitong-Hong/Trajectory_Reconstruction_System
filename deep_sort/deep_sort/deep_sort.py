...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, clss, ori_img):
        ...
        # print("in deep_sort.py, bbox_xywh:",bbox_xywh)
    ...
    def _get_features(self, bbox_xywh, ori_img):
        ...
        for box in bbox_xywh:
            ...
            # print("box cnt",cnt)
            # print("box",box)
            # print("x y w h",box[0],box[1],box[2],box[3])
        ...
        if im_crops:
            # print("im_crops.shape",type(im_crops[0]))
            # 列表长度为frame下的bbox数，每个元素为一个bbox的图像(W, H, 3)
